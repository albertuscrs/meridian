...
import { htmlEscape, formatCandidates, formatHelpText, fmtPct, fmtAge, positionStatusEmoji, feeTvlBar } from "./display.js";
import { parseConfigValue, formatConfigSnapshot, showSettingsMenu, applySettingsMenuCallback, hasPendingInput, takePendingInput } from "./settings-menu.js";
import { buildObserveReport, buildObserveCompare, buildObserveHeld, buildObserveReasons } from "./observe-report.js";
...
async function telegramHandler(msg) {
  ...
  if (hasPendingInput() && !msg.isCallback && !text.startsWith("/")) {
    const { key, page, menuMsgId } = takePendingInput();
    let value;
